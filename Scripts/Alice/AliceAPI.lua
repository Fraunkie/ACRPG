...
--[[
    ...
    ALICE_EnumObjectsInRegion(whichRegion, identifier, condition, ...)
    ...
    ALICE_ForAllObjectsInRegionDo(action, whichRegion, identifier, condition, ...)
    ALICE_GetClosestObject(x, y, identifier, cutOffDistance, condition, ...)
    ALICE_GetNClosestObjects(x, y, identifier, maxAmount, cutOffDistance, condition, ...)

    ALICE_IncludeSuspended(enable)                                                  Toggles whether objects that were suspended with ALICE_Suspend, widgets that were hidden
                                                                                    with ShowUnit, ShowItem, or ShowDestructable, and units loaded into transports are enumerated
                                                                                    by ALICE_Enum functions.
    ...
    ALICE_Select(qualifier)                                                         Select the actor of the specified object if qualifier is an object, the first actor
                                                                                    encountered with the specified identifier if qualifier is a string, or the actor with
                                                                                    the specified unique number if qualifier is an integer. Requires debug mode.
    ALICE_IsSelected(whichObject)                                                   Returns whether an actor attached to the specified object is selected.
    ALICE_GetSelectedObject()                                                       Returns the host of the actor currently selected in debug mode.
    ...
    ALICE_PairReset()                                                               Resets ALICE_PairIsFirstContact and calls the onReset function if it was reset.
    ...
    ALICE_IncludeTypes(whichType)                                                   Widgets with the specified fourCC codes will always receive actors, indepedent of the config
                                                                                    or whether they have the Locust ability.
    ...
    ALICE_Teleport(object, x, y, z)                                                 Instantly moves a unit, item, or gizmo to the specified coordinates and instantly updates
                                                                                    that object's coordinate lookup tables and cells. If the z-coordinate is not specified and
                                                                                    the object is a table, z is set to the terrain height of the target point. Works on stationary
                                                                                    objects.
