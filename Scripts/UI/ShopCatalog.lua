...
do
    ...
    ShopCatalog.Register({
        ...
        price = { gold = 0, capsuleCoin = 0, fragments = { db = 10, digi = 10, poke = 10, chakra = 10 }, souls = 0 },
        kind = "unlock",
    ...
    ShopCatalog.Register({
        ...
        price = { gold = 0, capsuleCoin = 1000, fragments = { db = 0, digi = 0, poke = 0, chakra = 0 }, souls = 0 },
        kind = "unlock",
        ...
        id = "Healing_Fruit",
        name = "Healing Fruit",
        desc = "A herb that restores health",
        icon = "ReplaceableTextures\\CommandButtons\\BTNHealingHerbItem.blp",
        price = { gold = 0, capsuleCoin = 100, fragments = { db = 0, digi = 0, poke = 0, chakra = 0 }, souls = 0 },
        kind = "item",
        payload = { companionId = "Healing_Fruit", rawcode = 'I00F' },
        unique = false,
        requirements = {},
        hubs = { "YEMMA" },
        enabled = true,
